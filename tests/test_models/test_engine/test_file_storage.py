...
class TestFileStorageDocs(unittest.TestCase):
    """Class testing FileStorage docs"""
    ...
    def test_doc_file(self):
        ...
        expected = 'module engine file_storage' 
        current = models.file_storage.__doc__
        self.assertEqual(expected, current)

    def test_doc_class(self):
        """... documentation for the class"""
        expected = "class serializes and des instances to a JSON file" 
        actual = FileStorage.__doc__
        self.assertEqual(expected, actual)

    def test_doc_all(self):
        """... documentation for all function"""
        expected = "return the dictionary"
    ...
    def test_doc_new(self):
        ...
        expected = "sets obj with the key <obj class name>.id in __objects"
